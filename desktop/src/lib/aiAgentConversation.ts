...
import type { FlammeKeyHeaders } from './flamme/headers'
...
export function createFlammeUnavailableResponse(): string {
  return 'Flamme AI 引擎未就绪。请等待启动完成，或在开发模式下运行 scripts/dev-flamme.ps1 启动 Python 后端。'
}
