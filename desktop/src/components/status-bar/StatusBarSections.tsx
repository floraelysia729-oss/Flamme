...
import { FlammeBadge } from './FlammeBadge'
...
interface StatusBarPrimarySectionProps {
  ...
  flammeRuntimeState?: FlammeRuntimeState
  onFlammeHealthRetry?: () => void
  flammeKeys?: FlammeKeyHeaders
  flammeEmbeddingProgress?: { embedded: number; total: number } | null
  stacked?: boolean
  compact?: boolean
  locale?: AppLocale
}
...
function StatusBarPrimaryBadges({
  ...
  claudeCodeStatus,
  claudeCodeVersion,
  flammeRuntimeState = 'rust_only',
  onFlammeHealthRetry,
  flammeKeys,
  flammeEmbeddingProgress,
  vaultPathForFlamme = '',
  isOffline,
  isVaultReloading,
  compact,
  ...
  return (
    <>
      ...
      <FlammeBadge
        ...
        vaultPath={vaultPathForFlamme}
        keys={flammeKeys}
        embeddingProgress={flammeEmbeddingProgress}
        onRetry={onFlammeHealthRetry}
  ...
  return (
    <>
      <StatusBarPrimaryBadges
        ...
        flammeRuntimeState={flammeRuntimeState}
        onFlammeHealthRetry={onFlammeHealthRetry}
        flammeKeys={flammeKeys}
        flammeEmbeddingProgress={flammeEmbeddingProgress}
        vaultPathForFlamme={vaultPath}
