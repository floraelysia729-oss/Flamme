...
import { FlammeSettingsSection, settingsFlammeFieldsFromDraft } from './FlammeSettingsSection'
...
interface SettingsPanelProps {
  ...
  onFlammeRebuildMessage?: (message: string) => void
}
...
function createSettingsDraft(
  ...
  return {
    ...
    flammeLlmKey: settings.flamme_llm_key ?? '',
    flammeEmbedKey: settings.flamme_embed_key ?? '',
    flammeBrainKey: settings.flamme_brain_key ?? '',
    flammeMineruToken: settings.flamme_mineru_token ?? '',
  }
}
...
function buildSettingsFromDraft(settings: Settings, draft: SettingsDraft): Settings {
  const nextSettings = {
    ...
    ...settingsFlammeFieldsFromDraft(draft),
  }
...
export function SettingsPanel({
  ...
  return (
    <SettingsPanelInner
      ...
      onClose={onClose}
      vaultPath={vaultPath}
      flammeApiReachable={flammeApiReachable}
      onFlammeRebuildMessage={onFlammeRebuildMessage}
    />
  )
}
...
function SettingsBodyFromDraft({
  ...
  return (
    <SettingsBody
      ...
      flammeLlmKey={draft.flammeLlmKey}
      setFlammeLlmKey={(value) => updateDraft('flammeLlmKey', value)}
      flammeEmbedKey={draft.flammeEmbedKey}
      setFlammeEmbedKey={(value) => updateDraft('flammeEmbedKey', value)}
      flammeBrainKey={draft.flammeBrainKey}
      setFlammeBrainKey={(value) => updateDraft('flammeBrainKey', value)}
      flammeMineruToken={draft.flammeMineruToken}
      setFlammeMineruToken={(value) => updateDraft('flammeMineruToken', value)}
      vaultPath={vaultPath}
      flammeApiReachable={flammeApiReachable}
      onFlammeRebuildMessage={onFlammeRebuildMessage}
    />
...
function SettingsAgentWorkflowSections({
  ...
  return (
    <>
      ...
      <FlammeSettingsSection
        vaultPath={vaultPath}
        flammeApiReachable={flammeApiReachable}
        flammeLlmKey={flammeLlmKey}
        setFlammeLlmKey={setFlammeLlmKey}
        flammeEmbedKey={flammeEmbedKey}
        setFlammeEmbedKey={setFlammeEmbedKey}
        flammeBrainKey={flammeBrainKey}
        setFlammeBrainKey={setFlammeBrainKey}
        flammeMineruToken={flammeMineruToken}
        setFlammeMineruToken={setFlammeMineruToken}
        onRebuildMessage={onFlammeRebuildMessage}
      />
